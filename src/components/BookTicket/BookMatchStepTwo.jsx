    ...
    <div className="space-y-6 bg-white p-16">
      ...
      <div className="bg-blue-50 p-4 rounded-lg border border-blue-200 flex justify-between items-center mb-4">
        <div className="flex items-center">
          <button className="text-blue-600 hover:bg-blue-100 p-1 rounded-full mr-3">
            <svg
        ...
        <div className="bg-white px-3 py-1 rounded-full border border-gray-200 text-sm font-medium flex items-center">
          <svg
            xmlns="http://www.w3.org/2000/svg"
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="md:col-span-2">
          ...
          <div className="space-y-4">
            {Object.keys(stadium.ticketPrices?.[typeSeat]).slice(0,4).map((section) => (
              <Link to='/bookThree' className="flex flex-col gap-2" key={section} onClick={()=>setSeat(section)}>
                <div
                  className={`border rounded-lg p-4 cursor-pointer hover:bg-blue-50 transition-colors ${currentSection === section ? "border-blue-500 bg-blue-50" : ""}`}
                  onClick={() => handleSectionSelect(section)}
                >
                  <div className="flex justify-between items-center">
                    <div className="flex items-center">
                      <div>
                        <div className="font-bold text-lg">{section.charAt(0).toUpperCase() + section.slice(1)}</div>
                        <div className="text-sm text-gray-600">
                          {section.includes("premium")
                            ? "Enhanced viewing experience"
                            : section.includes("vip") || section.includes("premium")
                    ...
                    <div className="text-lg font-bold text-blue-600">
                      £{stadium.ticketPrices?.[typeSeat][section]}
                    </div>
                  </div>
                </div>
              </Link>
