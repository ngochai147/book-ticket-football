...
function Footer() {
  const socialLinks = [
    { icon: FaFacebook, href: '#', color: 'text-blue-500 hover:text-blue-700' },
    { icon: FaTwitter, href: '#', color: 'text-cyan-400 hover:text-cyan-600' },
    { icon: FaInstagram, href: '#', color: 'text-pink-500 hover:text-pink-700' }
  ];
        ...
        <div className="flex flex-col md:flex-row justify-between items-center md:items-start gap-10">
          ...
          <div className="flex flex-col items-center md:items-start">
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-3xl font-extrabold tracking-tight">SportPulse</h2>
            </div>
          ...
          <div className="w-full md:w-auto flex flex-col items-center md:items-start">
            <h3 className="text-xl font-semibold mb-4 text-center md:text-left">Get Updates</h3>
            <div className="flex w-full max-w-sm">
              <input
                type="email"
                placeholder="Enter your email"
                className="w-full px-4 py-2 bg-gray-800 text-white rounded-l-lg focus:outline-none focus:ring-2 focus:ring-red-500"
              />
