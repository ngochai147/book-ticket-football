...
function LoginModal({ onClose, onLoginSuccess }) {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      // --- Chỉ thực thi khi API thành công (status 2xx) ---
      ...
      onLoginSuccess({ // Gọi hàm callback báo thành công cho component cha
      ...
      onClose(); // <-- Chỉ gọi onClose() KHI THÀNH CÔNG
      // ---------------------------------------------------

    }  catch (error) {
      console.log("LOGIN FAILED - CATCH BLOCK EXECUTED"); // Thêm dòng này
      const errorMessage =
        error.response?.data?.message || "Đăng nhập thất bại. Vui lòng thử lại.";
      console.error("Login error:", errorMessage, error.response); // Log cả response để xem status
        ...
        <div className="md:w-1/2 flex flex-col justify-center items-start p-10 bg-[#001840] relative">
          ...
          <div className="relative z-10 w-full">
            ...
            <p className="mb-8 text-blue-100 text-lg leading-relaxed">
              Create an account to book tickets for your favorite matches and never miss a game!
            </p>
            <button
            ...
            <a
              href="#"
              className="text-blue-300 hover:text-blue-100 hover:underline flex items-center group"
              onClick={handleWhyRegister}
            >
          ...
          <div className="relative z-10">
            ...
            <form className="space-y-6">
              ...
              <div className="flex items-center space-x-3">
                ...
                />
                <label htmlFor="saveLogin" className="text-sm text-blue-100">
                  Remember me
                </label>
              </div>
